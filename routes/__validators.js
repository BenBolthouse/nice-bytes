/**
 * * ======================================================
 * *  User Form Validation Middleware
 * * ======================================================
 */
...
/**********************************************************
 * Schema applies constraints to user sign up event.
 */
const validateSignUp = [
  check("username")
    ...
    .withMessage(
      'Username can only contain letters, numbers and the characters "-" and "_".'
    ),
  check("email")
    .exists({ checkFalsy: true })
...
/**********************************************************
 * Schema applies constraints to user login event.
 */
const validateLogin = [
